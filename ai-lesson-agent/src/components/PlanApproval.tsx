...
export function PlanApproval({
  ...
  const approveDisabled = objectives.length === 0 || isValidating || hasInvalid;
        ...
        {objectives.length === 0 ? (
          ...
          <ul className="divide-y divide-stone-100">
            {objectives.map((obj, i) => (
              <li key={i} className={`px-4 py-3 group relative ${i === 0 ? "rounded-t-xl" : ""} ${i === objectives.length - 1 ? "rounded-b-xl" : ""}`}>
